				...
				<li class="active">
					...
					<ul class="sub-menu">
						...
						<li>
							...
							<a href="admin_goods_setIsSell.html">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">输入商品信息</span>
								...
								<form action="./api/user/registByAdmin" class="form-horizontal" id="formd">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="name" class="m-wrap small" id="name">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="price" class="m-wrap small" id="price">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="goodstype" class="m-wrap small" id="goodstype" value="套餐" readonly="readonly">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="address" class="m-wrap large" id="address">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="sex" class="m-wrap small" id="sex">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="age" class="m-wrap small" id="age">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="tel" class="m-wrap medium" id="tel">
									...
									<label class="control-label">套餐内容</label>
										...
										<div class="controls">
											...
											<textarea class="large m-wrap" id="des" rows="3"></textarea>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select class="small m-wrap" tabindex="1" id="isSell">
										...
										<div class="controls">
											...
											<div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden" value="" name="">
												...
												<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
													...
													<img src="media/image/9.jpg" alt="" id="imghead">
												...
												<div>
													...
													<input type="text" class="default" id="url" style="display: none;">

													</span>

													<a href="#" class="btn fileupload-exists" data-dismiss="fileupload">移除文件</a>

													<a href="#" class="btn" id="upimg">上传</a>
    ...
    return result;
		...
		jQuery(document).ready(function() {    
		   ...
		   $("#up").click(function(){
		   	...
		   	$.ajax({
		   		type:"GET",
		   		url:"./api/goods/add?name={name}&price={price}&img={img}&des={des}&isSell={isSell}&goodstype={goodstype}&address={address}&sex={sex}&age={age}&tel={tel}".format(data),
