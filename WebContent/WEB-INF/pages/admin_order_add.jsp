						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">输入订单信息</span>
								...
								<form action="./api/user/registByAdmin" class="form-horizontal" id="formd">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="ordertype" class="m-wrap small" id="ordertype">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="sum" class="m-wrap small" id="sum">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="goods" class="m-wrap large" id="goods">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="uid" class="m-wrap small" id="uid">
