						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">输入用户信息</span>
								...
								<form action="./api/user/registByAdmin" class="form-horizontal" id="formd">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="username" class="m-wrap small" id="username">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="password" placeholder="password" class="m-wrap medium" id="password">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="money" class="m-wrap medium" id="money">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select class="small m-wrap" tabindex="1" id="power">
	...
	<script>
		...
		jQuery(document).ready(function() {    
		   ...
		   $("#up").click(function(){
		   	...
		   	$.ajax({
		   		type:"GET",
		   		url:"./api/user/registByAdmin?username="+username+"&password="+password+"&money="+money+"&img="+url+"&power="+power,
