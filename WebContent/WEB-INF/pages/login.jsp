...
<body class="login">
  ...
  <div class="content">
    ...
    <form class="form-vertical login-form" action="./api/login">
      ...
      <div class="form-actions">
        ...
        <input type="checkbox" name="remember" value="1"/> 请！记住我！

        </label>

        <button type="button" class="btn green pull-right" id="up">
