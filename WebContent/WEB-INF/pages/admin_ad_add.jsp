						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">输入广告信息</span>
							...
							<div class="portlet-body form">
								...
								<form action="./api/user/registByAdmin" class="form-horizontal" id="formd">
									...
									<div class="control-group">
										...
										<label class="control-label">广告信息</label>

										<div class="controls">

											<input type="text" placeholder="msg" class="m-wrap small" id="msg">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="goodsid" class="m-wrap medium" id="goodsid">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="adurl" class="m-wrap medium" id="adurl">
	...
	<script>
		...
		jQuery(document).ready(function() {    
		   ...
		   $("#up").click(function(){
		   	...
		   	$.ajax({
		   		type:"GET",
		   		url:"./api/ad/add?msg="+msg+"&goodsid="+goodsid+"&url="+adurl+"&img="+url,
