							...
							<div class="portlet-body form">
								...
								<form action="./api/user/registByAdmin" class="form-horizontal" id="formd">
									...
									<div class="control-group">
										...
										<label class="control-label">价格/小时</label>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="goodstype" class="m-wrap small" id="goodstype">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="des" class="m-wrap large" id="des">
